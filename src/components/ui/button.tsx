...

  {
    variants: {
      variant: {
        ...
        hero:
          "bg-gradient-to-tr from-[hsl(var(--primary))] to-[hsl(var(--accent))] text-primary-foreground shadow-[var(--shadow-elegant)] hover:opacity-95 hover:shadow-[var(--shadow-glow)] transition-transform hover:scale-[1.01] active:scale-[0.99]",
      },
      size: {
